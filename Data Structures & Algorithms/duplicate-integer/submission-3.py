class Solution:
    def hasDuplicate(self, nums: List[int]) -> bool:
        ...
        3. Maintaing a set of traversed elements:
            ...
            > Time complexity: O(n)
            > Space complexity: O(n) — worst case, all elements added to set
            > IMP Advantage over approach 1: early exit when duplicate found early
            > Approach 3 beats Approach 1 in the best case on both time and space
